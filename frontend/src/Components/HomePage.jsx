...
function HomePage() {
  ...
  return (
    <div className="relative">
      <div className="w-[100vw] py-14 bg-[#000000]">
        <div className="flex bg-[#f0f2f5] h-[90vh] absolute top-[5vh] left-[2vw] w-[96vw]">
          <div className="left w-[30%] h-full bg-[#ececec]">
          ...
          {!currentChat?.id && (
            <div className="w-[70%] flex flex-col items-center justify-center h-full bg[#000000]">
              <div className="max-w-[70%] text-center">
                <img
                  ...
                  alt="Live chat"
                />
                <h1 className="text-4xl text-gray-600">Live Chat Web</h1>
                <p className="my-9">
                  Send and receive messages with live chat and save time.
                </p>
              </div>
            </div>
          )}
